...
//        photoAdapter.registerDataSetObserver(circleindicator.dataSetObserver)
        //load Dialog
        val loadingDialog=LoadingDialog(mMainActivity)
        ...
        firebaseService.getCategories{ listCategories->

            val listCategoryApdapter = ListCategoryApdapter(mMainActivity,listCategories)
